package com.asia.lottery.common;
...
public class Constants {
    ...
    /**
     * 活动状态：1 编辑；2 提审；3 撤审；4 通过；5 运行（审核通过后 worker 扫描状态）；6 拒绝；7 关闭；8 开启
     */
    ...
    public enum StrategyMode {
        ...
        /**
         * 总体概率：如果 A 奖品抽空后，B 和 C 奖品的概率按照 3:5 均分，相当于 B 奖品中奖概率由 0.3 升为 0.375
         */
        ENTIRETY(2, "总体概率");
