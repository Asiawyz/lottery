...
import com.asia.lottery.domain.strategy.service.draw.DrawBase;
...
public class DrawExecImpl extends DrawBase implements IDrawExec {
    ...
    public DrawResult doDrawExec(DrawReq req) {
        logger.info("执行抽奖策略，strategyId：{}",req.getStrategyId());
        ...
        logger.info("执行抽奖策略完成，中奖用户：{}，奖品ID：{}，奖品名称：{}", req.getuId(), awardId, award.getAwardName());
